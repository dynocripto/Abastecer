...
INSERT INTO `empleados` (`empleado_id`, `nombre`, `apellido`, `edad`, `direccion`, `cedula`, `telefono`, `correo`, `fecha_nac`, `estatus`) VALUES
...
CREATE TABLE `curso` (
  ...
  `capacitador_id` int(11) DEFAULT NULL,
...
INSERT INTO `curso` (`curso_id`, `materia_id`, `capacitador_id`, `estatusC`) VALUES
(1, 1, 1, 1),
(108, 11, 1, 1);
...
INSERT INTO `inscripcion` (`inscripcion_id`, `empleado_id`, `curso_id`, `turno_id`, `estatusI`) VALUES
(64, 1, 1, 1, 1),
(65, 3, 108, 1, 1);
...
INSERT INTO `capacitador` (`capacitador_id`, `nombre`, `apellido`, `direccion`, `cedula`, `telefono`, `correo`, `nivel_est`, `estatus`) VALUES
...
ALTER TABLE `curso`
  ...
  ADD KEY `curso_ibfk_2` (`capacitador_id`);
...
ALTER TABLE `inscripcion`
  ...
  ADD KEY `inscripcion_ibfk_2` (`empleado_id`);
...
ALTER TABLE `capacitador`
  ADD PRIMARY KEY (`capacitador_id`);
...
--
ALTER TABLE `capacitador`
  MODIFY `capacitador_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
ALTER TABLE `curso`
  ...
  ADD CONSTRAINT `curso_ibfk_2` FOREIGN KEY (`capacitador_id`) REFERENCES `capacitador` (`capacitador_id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `inscripcion`
  ...
  ADD CONSTRAINT `inscripcion_ibfk_2` FOREIGN KEY (`empleado_id`) REFERENCES `empleados` (`empleado_id`) ON DELETE CASCADE ON UPDATE CASCADE,
